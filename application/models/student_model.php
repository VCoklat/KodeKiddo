...
class Student_model extends CI_Model
{
     ...
     */
    function studentListingCount($searchText = '', $branch_data1='')
    {
     ...
     */
    function studentListing($searchText = '', $branch_data1='', $page, $segment)
    {
		$this->db->select('BaseTbl.studentId, Status.status, BaseTbl.parent_name,BaseTbl.parent_email, BaseTbl.name,BaseTbl.age,BaseTbl.kelas,BaseTbl.school, BaseTbl.mobile, Schedule.schedule,Schedule.day, BaseTbl.address, Source.source, Branch.name_branch');
		$this->db->from('tbl_students as BaseTbl');
		$this->db->join('tbl_branchs as Branch', 'Branch.branchId = BaseTbl.branchId and Branch.isDeleted =0','left');
		$this->db->join('tbl_status as Status', 'Status.statusId = BaseTbl.status','left');
		$this->db->join('tbl_source as Source', 'Source.sourceId = BaseTbl.source','left');
